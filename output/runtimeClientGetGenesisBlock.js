...
try {
  ...
  out(await nic.runtimeClientGetGenesisBlock(oasis.misc.fromHex('000000000000000000000000000000000000000000000000f80306c9858e7279' /* sapphireConfig.mainnet.runtimeId */)))
} catch (err) {
